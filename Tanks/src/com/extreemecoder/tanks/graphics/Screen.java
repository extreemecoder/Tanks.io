...
import com.extreemecoder.tanks.entity.mob.Chaser;
import com.extreemecoder.tanks.entity.mob.Mob;
import com.extreemecoder.tanks.entity.mob.Star;
	...
	public void renderMob(int xp, int yp, Mob mob) {
		...
		for (int y = 0; y < 32; y++) {
			...
			for (int x = 0; x < 32; x++) {
				...
				if ((mob instanceof Chaser) && col == 0xff3F48CC) col = 0xffBA0015;
				if ((mob instanceof Star) && col == 0xff3F48CC) col = 0xffE8E83A;
				if (col != ALPHA_COL) pixels[xa + ya * width] = col;
			}
		}
	}
